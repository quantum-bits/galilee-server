...
function randomResources() {
    return _.times(random.integer(0, 4), n => {
        let resource = {
            // These fields are stored in the stepResource entity
            // (specific to a step's use of a resource).
            seq: n + 1,
            description: faker.lorem.paragraphs(random.integer(1, 3)),
            resourceFile: randomResourceFile(),

            // Everything else is for the resource entity proper
