...
exports.up = function (knex, Promise) {
    ...
    return Promise.all([
        ...
        knex.schema.createTableIfNotExists('reading_type', function (table) {
            table.increments('id');
            table.string('title').notNullable();
        }),

        knex.schema.createTableIfNotExists('reading', function (table) {
            table.increments('id');
            table.integer('seq');
        ...
        knex.schema.createTableIfNotExists('pericope', function (table) {
            table.increments('id');
            table.integer('reading_id').references('reading.id');
        }),

        knex.schema.createTableIfNotExists('passage', function (table) {
            table.increments('id');
            table.integer('seq');
