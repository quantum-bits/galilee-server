...
exports.up = function (knex, Promise) {
    ...
    return Promise.all([
        ...
        knex.schema.createTableIfNotExists('cycle', table => {
            table.string('id', 1).primary();
            table.string('title');
        }),

        knex.schema.createTableIfNotExists('calendar_year', table => {
        ...
        knex.schema.createTableIfNotExists('calendar_date', table => {
            table.increments('id');
        ...
        knex.schema.createTableIfNotExists('pericope_date', table => {
